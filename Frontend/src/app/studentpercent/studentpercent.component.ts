...
@Component({
  selector: 'app-studentpercent',
  imports: [FormsModule, CommonModule, NavbarLoggedComponent],
  templateUrl: './studentpercent.component.html',
  styleUrl: './studentpercent.component.css'
})
export class StudentpercentComponent implements OnInit {
