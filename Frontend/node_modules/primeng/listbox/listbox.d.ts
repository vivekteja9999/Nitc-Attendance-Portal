...
import { FilterService, PrimeTemplate, ScrollerOptions } from 'primeng/api';
 ...
 * @group Components
 */
export declare class Listbox extends BaseComponent implements AfterContentInit, OnInit, ControlValueAccessor, OnDestroy {
